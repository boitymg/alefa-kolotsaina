            ...
            <Link to={`/agenda/${event.id}`} className="block">
                ...
                <div className="flex items-start gap-8">
                    ...
                    <div className="flex-grow">
                        ...
                        <h2 className="text-[clamp(1.5rem,8vw,4.5rem)] lg:text-7xl font-black brand-heading mb-8 group-hover:text-[#FF5733] transition-colors leading-[0.95] uppercase whitespace-nowrap overflow-hidden text-ellipsis">
                            {event.titre}
                        </h2>
